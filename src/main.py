...
async def lifespan(app: FastAPI):
    ...
    app.vector_store.load_vector_store(settings.VECTOR_STORE_PATH, app.embedding_client.embed_text)

    app.rag_client = RAGProvider(vectordb_client=app.vector_store, generation_client=app.generation_client,
